...
class UniformGlueWorkOrder(models.Model):
    ...
    work_order_number = models.ForeignKey('WorkOrder', models.DO_NOTHING, db_column='work_order_number', db_comment='所属工单编号')
    ...
    process_material_id = models.CharField(max_length=25, blank=True, null=True, db_comment='物料id')
    layer_name = models.CharField(max_length=25, blank=True, null=True, db_comment='层数')

    class Meta:
        managed = False
        db_table = 'uniform_glue_work_order'
